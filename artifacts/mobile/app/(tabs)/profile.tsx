      ...
      items: [
        {
          ...
          onPress: () => {
            ...
            Alert.alert(
              'Change Passcode',
              'Set a 6-digit PIN to secure your MindWealth account.\n\nBiometric authentication is also available.',
              [{ text: 'OK' }],
            );
          },
        },
        ...
        },
        {
          ...
          onPress: () => {
            ...
            Alert.alert(
              'Privacy Settings',
              'MindWealth AI only uses your data to personalize your coaching experience. We never sell your data.\n\nData stored locally on your device.',
              [{ text: 'OK' }],
            );
          },
        },
